 ...
 */
public class SendDailyArticleCommand extends AbstractCommandExecute {
    ...
    public void execute(XmlMsg msg, SysUserPO userPO) {
        ...
        MongoCollection<Document> collection = mongoClient.getDatabase(database).getCollection(collectionDaily);
        ...
        redisDao.addVal(WECHAT_DAILY_PROFIX+token, yesterdayDaily.toJson(), 22, TimeUnit.HOURS);
...
　　为网页位置指定标识符，有两个方法。一是使用锚点，比如<a name="print"></a>，二是使用id属性，比如<div id="print">。
         */
        //TODO
        String url = "http://10.22.9.2/wechat/daily.html#"+token;

        Optional<BasicDBObject> reOption = wechatConfig.sendMessage(json);
